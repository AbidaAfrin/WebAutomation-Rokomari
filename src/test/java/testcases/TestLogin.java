...
//        homePage.clickOnElement(homePage.signInButton);
        ...
        signInPage.clickOnElement(signInPage.nextButton1);
    ...
    public void testLoginWithValidOTP() {
        ...
        signInPage.writeOnElement(signInPage.otpInputBox, signInPage.OTP);
        //  signInPage.addScreenshot("After add data");
        signInPage.clickOnElement(signInPage.logInButton);
        //  signInPage.addScreenshot("After login");
        Assert.assertTrue(homePage.displayStatus(homePage.userIcon));
    ...
    public void testLoginWithInValidOTP() {
        ...
        signInPage.writeOnElement(signInPage.otpInputBox, signInPage.OTP);
        signInPage.clickOnElement(signInPage.logInButton);
        Assert.assertTrue(signInPage.displayStatus(signInPage.otpErrorMsg));
    }
